...
function deviceMoved() {   
    r = map(accelerationX, -90, 90, 100, 255);
    g = map(accelerationY, -90, 90, 100, 255);
    b = map(accelerationZ, -90, 90, 100, 255);   
}
...
Bar.prototype = {
	...
	rect(this.x, this.y, this.diam + forceX, this.diam* + forceY);		
